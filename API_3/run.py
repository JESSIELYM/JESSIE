import  unittest
from 接口自动化.API_3.test_results.test_report import HTMLTestRunnerNew
from 接口自动化.API_3.test_case import test_register  #导入用例模块
from 接口自动化.API_3.test_case import test_recharge
