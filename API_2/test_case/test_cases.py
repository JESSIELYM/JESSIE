...
from 接口自动化.API_2.common.http_request import HttpRequests
from 接口自动化.API_2.common.do_excel import DoExcel
from 接口自动化.API_2.common import project_path
from 接口自动化.API_2.common.test_log import MyLog
test_data = DoExcel(project_path.case_path, 'API_01_TC').Read_Excel()
@ddt
class TestCases(unittest.TestCase):
    def setUp(self):
        self.t = DoExcel(project_path.case_path, 'API_01_TC')
    def tearDown(self):
        pass
    @data(*test_data)
